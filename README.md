...
#### 資格 : 基本情報技術者
### 将来の展望
ユーザー体験を追求するゲーム・XR系エンジニアを目指したい。分かりやすく、ストレスのないゲームシステムやUIを追求し、いずれはグラフィック面やデザイン面の知識も持ったエンジニアになりたい！
...
## Hackathon ～Open Hack U Spring OSAKA～ (2023/03)

### 概要
Yahoo主催のオフライン開催のハッカソン。初のリーダー兼UnityエンジニアとしてIdea×Techのメンバー5人とともに参加した。

### 使用技術・フレームワーク(カッコ付きは自身の触れていない使用技術)
Unity / MRTK3 / ARFoundation / GeospatialAPI / PLATEAU SDK / (ChatGPT3) / (PUN2) / (whisper) / (VoiceVox Engine) / (Blender) / (CUBASE)

### 開発物
VR空間上にハブエリアとしての役割を持つ大阪駅周辺の都市空間が構築されており、特定のランドマークを舞台として2人同時対戦型のゲームを遊ぶことができるゲームアプリ。また、現実の同じ建物まで足を運ぶことで、AR空間上でも同様のゲームを体験できるようにした。

### 具体的な担当箇所
VR側のフロントエンド・一部バックエンドを主に担当。アプリの立ち上げからゲーム開始までの導線部分を作成し、また、他メンバーが作成したゲームコンテンツをVR側に落とし込む作業をした。また、チームにUnityを使った開発が初めてであったメンバーがいたのでその補助も担当した。リーダーとしては、メンバーの開発進行状況の確認や業務連絡などを行った。

### 学んだこと・良かったこと
・MRTK3を用いたVR開発の基礎部分を固めることができた。
・リーダーを経験したことでチーム開発における報連相の重要性を深く実感した。
・会場での展示会で休む暇もないほどの多くの参加者に自分たちの作成したVR・ARゲームを体験してもらうことができ、楽しんでいる姿を見ることができた。

### 今後の課題
・VR・ARの完全な同期までしたかったが、開発期間の関係上できなかったので継続開発としてその機能を実装したい。
・賞を取ることができなかった原因の一つとして、何か特定の課題に対して解決できる開発物というコンセプトではなかったので現実の課題解決にもつながるアイデアを入れて次に活かしたい。
...
### 概要
個人開発物として現在も制作を進めているVRゲーム。個人でかつハッカソンよりも比較的長い時間をかけられることから、ユーザー体験の良さを追求するという点に焦点を当てている。

### 使用技術
Unity / Oculus Integration

### 開発物
ゲーム名「VILL DEFENDER」VRタワーディフェンス型ゲームで、自ら体を動かして防衛対象を剣や魔法を駆使して守る。チュートリアルを充実させて初めてのVRプレイにも適するようなゲームも目指している。

### 力を入れている部分
前述のとおり、ユーザーフレンドリーなゲームとなるように分かりにくい部分を極力つぶしていくようにしている。また、特にチュートリアルには長い時間をかけ、簡単なストーリー仕立てにして楽しめるようにした。
